class AttributesStoragePage:
    ...
    read_data_for_the_last = {
        "title_en": "Read data for the last",
        "title_es": "Leer datos para los últimos",
        "title_ru": "Вычитывать данные за последние",
        "control_type": "Pane",
    }
    use_storage_of_attributes = {
        "title_en": "Use storage of attributes",
        "title_es": "Usar almacenaje de atributos ",
        "title_ru": "Использовать хранилище атрибутов",
        "control_type": "Pane",
    }
    log_level = {
        "title_en": "Log level  ",
    ...
    connection_to_db = {
        "title_en": "Connection to DB",
        "title_es": "Conexión a base de datos",
        "title_ru": "Подключение к БД",
        "control_type": "Pane",
    }
    sql_server = {
        "title_en": "SQL Server",
        "title_es": "Servidor SQL ",
        "title_ru": "SQL cервер",
        "control_type": "Pane",
    }
    database = {
        "title_en": "Database",
        "title_es": "Base de datos",
