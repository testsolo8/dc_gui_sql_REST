class OutlookCalendarsPage:
    ...
    connection_to_exchange_server = {
        ...
        "attribute_ru": "Подключение к серверу ExchangePane",
    }
    ...
    server_address = {
        ...
        "attribute_ru": "Адрес сервераPane",
    }
    ...
    username = {
        ...
        "attribute_ru": "Имя пользователяPane",
    }
    ...
    maximum_time_of_script_execution = {
        ...
        "attribute_ru": "Максимальное время выполнения скриптаPane",
    }
    ...
    read_calendars_every = {
        ...
        "attribute_ru": "Вычитывать календари каждыеPane",
    }
    ...
    externalAPI_address = {
        ...
        "attribute_ru": "Адрес ExternalAPIPane",
    }
    ...
    start_service_of_reading_outlook_calendars = {
        ...
        "attribute_ru": "Включить службу чтения календарей OutlookPane",
    }
