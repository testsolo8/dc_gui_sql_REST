...
body = {"protocolIds": ["e3cde09b-6779-49ba-9acc-f0dd3400ee92"], "limit": 1000}
...
@allure.story("Запрос имени файла в хранилище атрибутов по индексу WhatsApp")
class TestRequestFilenameInAttributeStoreByIndexes:
    ...
    def test_return_data(self):
        data = [
            "лермонтов_34_pass_qwerty.rar:лермонтов_34.txt",
            "лермонтов_34_pass_qwerty.rar",
        ]
        data_dict = r.json()
        data_str = json.dumps(data_dict)
        parsed_data = json.loads(data_str)
