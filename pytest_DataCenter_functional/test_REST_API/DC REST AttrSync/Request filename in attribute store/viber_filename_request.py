...
body = {"protocolIds": ["b2c87449-92c0-453a-946d-2574690ee35e"], "limit": 1000}
...
@allure.story("Запрос имени файла в хранилище атрибутов по индексу Viber")
class TestRequestFilenameInAttributeStoreByIndexes:
    ...
    def test_return_data(self):
        data = [
            "c:\\users\\admin1.test\\documents\\viberdownloads\\publicaccountmedia\\0-04-01-5a6042adf5e3dc2745e5c77adf60cbe14227f8ec8deff8af0f653a15e4413c37_fb79c55f3209086a.png"
        ]
        data_dict = r.json()
        with allure.step("Возвращаемые данные"):
            check.is_true(set(data).issubset(data_dict))
        with allure.step("Кол-во данных"):
            check.equal(len(data_dict), 1)
