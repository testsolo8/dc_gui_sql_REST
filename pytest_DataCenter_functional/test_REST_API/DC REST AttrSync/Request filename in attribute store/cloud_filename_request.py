...
@allure.story("Запрос имени файла в хранилище атрибутов по индексу Cloud")
class TestRequestFilenameInAttributeStoreByIndexes:
    ...
    def test_return_data(self):
        data = [
            "анкета участника закупочнои процедуры.xlsx&ved=2ahukewj6mdky8ej4ahu-qfedhssybmu4kbawegqibrab",
            "134.jpg",
            "dialogi_9.txt",
            "11399521.a4.zip:11399521.a4.pdf",
            "chevron.svg",
        ]
        data_dict = r.json()
