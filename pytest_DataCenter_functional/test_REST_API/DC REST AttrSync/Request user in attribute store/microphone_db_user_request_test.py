...
@allure.story("Запрос пользователя в хранилище атрибутов по бд Microphone")
class TestRequestUserInAttributeStoreByDB:
    ...
    def test_return_data(self):
        data = [
            "sampleuser0001@domain.local",
            "sampleuser0002@domain.local",
            "sampleuser0003@domain.local",
        ]
        data_dict = r.json()
