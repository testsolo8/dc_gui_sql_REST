...
@allure.story("Запрос хоста в хранилище атрибутов по индексу Mail")
class TestRequestMailHostInAttributeStoreByIndexes:
    ...
    def test_return_data(self):
        ...
        with allure.step("Возвращаемые данные"):
            check.equal(data_dict, ["online.metro-cc.ru"])
