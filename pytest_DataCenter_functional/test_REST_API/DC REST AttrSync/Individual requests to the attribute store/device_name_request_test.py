...
path = "https://" + base_url_dc() + ":9088/datacenter/api/v2/attributes/dev_name"
...
@allure.story("Запрос имени устройства в хранилище атрибутов по индексу Device")
class TestRequestDeviceNameInAttributeStoreByIndexes:
