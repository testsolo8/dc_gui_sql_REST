...
path = "https://" + base_url_dc() + ":9088/datacenter/api/v2/attributes/active_process"
...
@allure.story("Запрос имени активного процесса в хранилище атрибутов по бд Monitor")
class TestRequestMonitorNameActiveProcessInAttributeStoreByIndexes:
    ...
    def test_return_data(self):
        data = ["chrome.exe", "slack.exe", "explorer.exe"]
        data_dict = r.json()
        data_str = json.dumps(data_dict)
        parsed_data = json.loads(data_str)
