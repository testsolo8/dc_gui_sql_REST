...
path = "https://" + base_url_dc() + ":9088/datacenter/api/v2/attributes/mic_name"
body = {"protocolIds": ["c0232255-4a74-4123-9224-7987c31c9cfe"], "limit": 1000}
...
@allure.story("Запрос имени микрофона в хранилище атрибутов по бд Microphone")
class TestRequestMicrophoneNameInAttributeStoreByIndexes:
