...
path = "https://" + base_url_dc() + ":9088/datacenter/api/v2/attributes/dev_type"
...
@allure.story("Запрос типа устройства в хранилище атрибутов по индексу Device")
class TestRequestDeviceTypeInAttributeStoreByIndexes:
    ...
    def test_return_data(self):
        ...
        with allure.step("Возвращаемые данные"):
            check.equal(data_dict, ["dvd/cd-rom"])
