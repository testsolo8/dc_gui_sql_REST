...
body = {"protocolIds": ["f5104f7d-5c4a-430d-bb11-c3159d621adf"], "limit": 1000}
...
@allure.story("Запрос имени компьютера в хранилище атрибутов по индексу Microphone")
