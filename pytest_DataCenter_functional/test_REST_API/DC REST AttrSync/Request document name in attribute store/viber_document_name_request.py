...
@allure.story("Запрос имени документа в хранилище атрибутов по индексу Viber")
class TestRequestDocumentNameInAttributeStoreByIndexes:
    ...
    def test_return_data(self):
        data = [
            "0-04-01-5a6042adf5e3dc2745e5c77adf60cbe14227f8ec8deff8af0f653a15e4413c37_fb79c55f3209086a.png"
        ]
        data_dict = r.json()
