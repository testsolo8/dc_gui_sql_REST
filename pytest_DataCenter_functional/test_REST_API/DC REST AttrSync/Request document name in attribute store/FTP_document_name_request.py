...
body = {"protocolIds": ["726d061e-b58a-49c7-ab21-6dc32e165a92"], "limit": 1000}
...
@allure.story("Запрос имени документа в хранилище атрибутов по индексу FTP")
class TestRequestDocumentNameInAttributeStoreByIndexes:
    ...
    def test_return_data(self):
        data = [
            "482 стр - о.генри. том 3 (2006)_1 стр.10.pdf",
            "01 track 06.wav",
            "01 track 01.wav",
            "01 - yellow submarine.mp3",
            "searchinform_x_bondarenko.pdf",
            "01 track 05.wav",
            "01 track 04.wav",
            "01 track 03.wav",
            "482 стр - о.генри. том 3 (2006)_1 стр.11.pdf",
            "01 track 02.wav",
            "15.jpg",
            "16.jpg",
            "482 стр - о.генри. том 3 (2006)_1 стр.9.pdf",
            "14.jpg",
            "01 track 07.wav",
            "05 track 04.wav",
        ]
        ...
        with allure.step("Кол-во данных"):
            check.equal(len(parsed_data), 16)
