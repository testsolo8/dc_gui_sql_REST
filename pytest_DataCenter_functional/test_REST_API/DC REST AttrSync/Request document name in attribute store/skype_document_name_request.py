...
body = {"protocolIds": ["7848dc5b-7efd-4ed2-8116-5cc43664cc4f"], "limit": 1000}
...
@allure.story("Запрос имени документа в хранилище атрибутов по индексу Skype")
class TestRequestDocumentNameInAttributeStoreByIndexes:
    ...
    def test_return_data(self):
        data = [
            "583 стр - prestuplenie-i-nakazanie-dr-izd_1.pdf",
            "774 стр - ручное огнестрельное оружие - краткое руководство. 11-е издание)01-00.jpg",
        ]
        data_dict = r.json()
        data_str = json.dumps(data_dict)
        parsed_data = json.loads(data_str)
