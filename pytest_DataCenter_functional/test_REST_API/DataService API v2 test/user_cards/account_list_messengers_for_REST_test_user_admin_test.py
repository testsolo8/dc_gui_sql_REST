...
url_tail = "/api/v2/data_center/user_cards/contacts/accounts?userID=5&contactTypeID=3"


@allure.epic("DataService API v2 (user_cards)")
@allure.feature("Account list messengers for REST_test_user_admin")
@pytest.mark.testRESTAPI
@allure.story("Мессенджеры пользователя REST_test_user_admin")
