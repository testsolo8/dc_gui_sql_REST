...
url_tail = (
    "/api/v2/data_center/user_cards/resolve?contact=REST_test_user_admin@autotest.lan&contactTypeID=0&"
    "accountTypeID=1"
)


@allure.epic("DataService API v2 (user_cards)")
@allure.feature("Procedure for obtaining UPN by contact REST_test_user_admin")
@pytest.mark.testRESTAPI
@allure.story("Процедура получения UPN по контакту REST_test_user_admin")
