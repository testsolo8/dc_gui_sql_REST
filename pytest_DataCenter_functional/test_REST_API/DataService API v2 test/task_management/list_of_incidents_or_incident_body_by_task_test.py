...
class TestListOfIncidentsOrIncidentBodyByTask:
    ...
    def test_task_3(self, dc_api: DcApiWithToken):
        ...
        with check.check, allure.step("Атрибуты инцидента"):
            assert_that(parsed_data["data"][0]["attributes"]).is_equal_to("")
        with check.check, allure.step("Комментарий к инциденту"):
            assert_that(parsed_data["data"][0]["comment"]).is_none()
        with check.check, allure.step("Дата создания"):
            assert_that(parsed_data["data"][0]["createDateTime"]).is_equal_to(1637740654)
        with check.check, allure.step("Идентификатор аккаунта"):
            assert_that(parsed_data["data"][0]["incidentID"]).is_equal_to(8)
        with check.check, allure.step("Уникальный идентификатор инцидента JSON"):
            assert_that(
                parsed_data["data"][0]["incidentUDL"]).is_equal_to(
                "<607.75.15402891><DB&ser08_pol_local_ec_files~202105140904#15402891@11&1><23>",
            )
        with check.check, allure.step("Продукт: 6 - AlertCenter, 11 - SIEM, 250 - AnalyticConsole"):
            assert_that(parsed_data["data"][0]["productID"]).is_equal_to(250)
        with check.check, allure.step("Текст инцидента"):
            assert_that(parsed_data["data"][0]["rawBody"]).is_equal_to("")
        with check.check, allure.step("Название файла инцидента в родном формате"):
            assert_that(parsed_data["data"][0]["rawName"]).is_equal_to("")
        with check.check, allure.step("Номер строки"):
            assert_that(parsed_data["data"][0]["rowNum"]).is_equal_to(1)
        with check.check, allure.step("Текст инцидента"):
            assert_that(parsed_data["data"][0]["textBody"]).is_equal_to("")
    ...
    def test_task_37(self, dc_api: DcApiWithToken):
        ...
        with check.check, allure.step("Атрибуты инцидента"):
            assert_that(parsed_data["data"][0]["attributes"]).is_equal_to("")
        with check.check, allure.step("Комментарий к инциденту"):
            assert_that(parsed_data["data"][0]["comment"]).is_equal_to("")
        with check.check, allure.step("Дата создания"):
            assert_that(parsed_data["data"][0]["createDateTime"]).is_equal_to(1659015383)
        with check.check, allure.step("Идентификатор аккаунта"):
            assert_that(parsed_data["data"][0]["incidentID"]).is_equal_to(188)
        with check.check, allure.step("Уникальный идентификатор инцидента JSON"):
            assert_that(parsed_data["data"][0]["incidentUDL"]).is_none()
        with check.check, allure.step("Продукт: 6 - AlertCenter, 11 - SIEM, 250 - AnalyticConsole"):
            assert_that(parsed_data["data"][0]["productID"]).is_equal_to(11)
        with check.check, allure.step("Текст инцидента"):
            assert_that(
                parsed_data["data"][0]["rawBody"]).is_equal_to(
    ...
    def test_task_48(self, dc_api: DcApiWithToken):
        ...
        with check.check, allure.step("Дата создания (инцидент 1)"):
            assert_that(parsed_data["data"][0]["createDateTime"]).is_equal_to(1661442148)
        with check.check, allure.step("Идентификатор аккаунта (инцидент 1)"):
            assert_that(parsed_data["data"][0]["incidentID"]).is_equal_to(234)
        with check.check, allure.step("Уникальный идентификатор инцидента JSON (инцидент 1)"):
            assert_that(
                parsed_data["data"][0]["incidentUDL"]).is_equal_to(
        ...
        with check.check, allure.step("Текст инцидента (инцидент 1)"):
            assert_that(parsed_data["data"][0]["rawBody"]).is_equal_to("")
        with check.check, allure.step("Название файла инцидента в родном формате (инцидент 1)"):
            assert_that(parsed_data["data"][0]["rawName"]).is_equal_to("")
        ...
        with check.check, allure.step("Атрибуты инцидента (инцидент 2)"):
            assert_that(parsed_data["data"][1]["attributes"]).is_equal_to("")
        with check.check, allure.step("Комментарий к инциденту (инцидент 2)"):
            assert_that(parsed_data["data"][1]["comment"]).is_none()
        with check.check, allure.step("Дата создания (инцидент 2)"):
            assert_that(parsed_data["data"][1]["createDateTime"]).is_equal_to(1661442148)
        with check.check, allure.step("Идентификатор аккаунта (инцидент 2)"):
            assert_that(parsed_data["data"][1]["incidentID"]).is_equal_to(235)
        with check.check, allure.step("Уникальный идентификатор инцидента JSON (инцидент 2)"):
            assert_that(
                parsed_data["data"][1]["incidentUDL"]).is_equal_to(
        ...
        with check.check, allure.step(
            ...
            assert_that(parsed_data["data"][1]["productID"]).is_equal_to(250)
        with check.check, allure.step("Текст инцидента (инцидент 2)"):
            assert_that(parsed_data["data"][1]["rawBody"]).is_equal_to("")
        with check.check, allure.step("Название файла инцидента в родном формате (инцидент 2)"):
            assert_that(parsed_data["data"][1]["rawName"]).is_equal_to("")
        with check.check, allure.step("Номер строки (инцидент 2)"):
            assert_that(parsed_data["data"][1]["rowNum"]).is_equal_to(2)
        with check.check, allure.step("Текст инцидента (инцидент 2)"):
            assert_that(parsed_data["data"][1]["textBody"]).is_equal_to("")
        with check.check, allure.step("Атрибуты инцидента (инцидент 3)"):
            assert_that(parsed_data["data"][2]["attributes"]).is_equal_to("")
        with check.check, allure.step("Комментарий к инциденту (инцидент 3)"):
            assert_that(parsed_data["data"][2]["comment"]).is_none()
        with check.check, allure.step("Дата создания (инцидент 3)"):
            assert_that(parsed_data["data"][2]["createDateTime"]).is_equal_to(1661442149)
        with check.check, allure.step("Идентификатор аккаунта (инцидент 3)"):
            assert_that(parsed_data["data"][2]["incidentID"]).is_equal_to(236)
        with check.check, allure.step("Уникальный идентификатор инцидента JSON (инцидент 3)"):
            assert_that(
                parsed_data["data"][2]["incidentUDL"]).is_equal_to(
        ...
        with check.check, allure.step(
            ...
            assert_that(parsed_data["data"][2]["productID"]).is_equal_to(250)
        with check.check, allure.step("Текст инцидента (инцидент 3)"):
            assert_that(parsed_data["data"][2]["rawBody"]).is_equal_to("")
        with check.check, allure.step("Название файла инцидента в родном формате (инцидент 3)"):
            assert_that(parsed_data["data"][2]["rawName"]).is_equal_to("")
        with check.check, allure.step("Номер строки (инцидент 3)"):
            assert_that(parsed_data["data"][2]["rowNum"]).is_equal_to(3)
        with check.check, allure.step("Текст инцидента (инцидент 3)"):
            assert_that(parsed_data["data"][2]["textBody"]).is_equal_to("")
        with check.check, allure.step("Атрибуты инцидента (инцидент 4)"):
            assert_that(parsed_data["data"][3]["attributes"]).is_equal_to("")
        with check.check, allure.step("Комментарий к инциденту (инцидент 4)"):
            assert_that(parsed_data["data"][3]["comment"]).is_none()
        with check.check, allure.step("Дата создания (инцидент 4)"):
            assert_that(parsed_data["data"][3]["createDateTime"]).is_equal_to(1661442149)
        with check.check, allure.step("Идентификатор аккаунта (инцидент 4)"):
            assert_that(parsed_data["data"][3]["incidentID"]).is_equal_to(237)
        with check.check, allure.step("Уникальный идентификатор инцидента JSON (инцидент 4)"):
            assert_that(
                parsed_data["data"][3]["incidentUDL"]).is_equal_to(
        ...
        with check.check, allure.step(
            ...
            assert_that(parsed_data["data"][3]["productID"]).is_equal_to(250)
        with check.check, allure.step("Текст инцидента (инцидент 4)"):
            assert_that(parsed_data["data"][3]["rawBody"]).is_equal_to("")
        with check.check, allure.step("Название файла инцидента в родном формате (инцидент 4)"):
            assert_that(parsed_data["data"][3]["rawName"]).is_equal_to("")
        with check.check, allure.step("Номер строки (инцидент 4)"):
            assert_that(parsed_data["data"][3]["rowNum"]).is_equal_to(4)
        with check.check, allure.step("Текст инцидента (инцидент 4)"):
            assert_that(parsed_data["data"][3]["textBody"]).is_equal_to("")
        with check.check, allure.step("Атрибуты инцидента (инцидент 5)"):
            assert_that(parsed_data["data"][4]["attributes"]).is_equal_to("")
        with check.check, allure.step("Комментарий к инциденту (инцидент 5)"):
            assert_that(parsed_data["data"][4]["comment"]).is_none()
        with check.check, allure.step("Дата создания (инцидент 5)"):
            assert_that(parsed_data["data"][4]["createDateTime"]).is_equal_to(1661442149)
        with check.check, allure.step("Идентификатор аккаунта (инцидент 5)"):
            assert_that(parsed_data["data"][4]["incidentID"]).is_equal_to(238)
        with check.check, allure.step("Уникальный идентификатор инцидента JSON (инцидент 5)"):
            assert_that(
                parsed_data["data"][4]["incidentUDL"]).is_equal_to(
        ...
        with check.check, allure.step(
            ...
            assert_that(parsed_data["data"][4]["productID"]).is_equal_to(250)
        with check.check, allure.step("Текст инцидента (инцидент 5)"):
            assert_that(parsed_data["data"][4]["rawBody"]).is_equal_to("")
        with check.check, allure.step("Название файла инцидента в родном формате (инцидент 5)"):
            assert_that(parsed_data["data"][4]["rawName"]).is_equal_to("")
        with check.check, allure.step("Номер строки (инцидент 5)"):
            assert_that(parsed_data["data"][4]["rowNum"]).is_equal_to(5)
        with check.check, allure.step("Текст инцидента (инцидент 5)"):
            assert_that(parsed_data["data"][4]["textBody"]).is_equal_to("")
