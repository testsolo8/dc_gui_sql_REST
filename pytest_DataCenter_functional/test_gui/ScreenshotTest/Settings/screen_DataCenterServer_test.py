...
class TestDataCenterServerPage:
    def test_data_center_server_screen(self, start_screen_test_page, assert_snapshot):
        ...
        elements = [
            {"name": "TitleBar", "element": window.TitleBar},
            {
                ...
                "element": window.by(class_name="TcxComboBox", control_type="Pane", found_index=0),
            },
        ]
