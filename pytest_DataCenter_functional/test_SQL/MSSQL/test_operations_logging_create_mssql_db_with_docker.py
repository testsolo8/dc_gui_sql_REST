...
class TestCreateMSSQLOperationsLoggingDB:
    ...
    def test_create_operations_logging_mssql_db(self, handle, db_data):
        ...
        with check.check:
            ...
            ).is_equal_to(operations_logging_mssql)
        delete_mssql_DB(sql_serv_addr, username, password, db_name)
...
class TestCreateMSSQLOperationsLoggingDBWithSpecSymbol:
    @pytest.mark.parametrize(
        argnames="db_data_spec", argvalues=testdata_spec_symbol, ids=test_ids_spec
    )
    def test_create_operations_logging_mssql_db_with_spec_symbols(
